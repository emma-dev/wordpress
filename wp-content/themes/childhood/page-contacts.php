<?php
/*
Template Name: Cantacts and Feedback
*/
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="contacts__map">
                    <?php echo do_shortcode('[yamap center="55.7473,37.6247" height="22rem" controls="" zoom="12" type="yandex#map" scrollzoom="0" mobiledrag="0"][/yamap]'); ?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="title contacts__minititle">
                    Contact us</div>
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    ...
                    <?php echo do_shortcode('[contact-form-7 id="112" title="Ota yhteyttä"]'); ?>
                </div>
